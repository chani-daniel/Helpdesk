...
#### אפשרות 1: התחברות עם משתמש קיים
התחבר עם אחד מהמשתמשים הקיימים במערכת:
...
#### אפשרות 2: הרשמה כמשתמש חדש
1. לחץ על "Don't have an account? Register" (או כפתור דומה בדף ההתחברות)
2. מלא את פרטי ההרשמה:
   - שם מלא
   - אימייל
   - סיסמה
3. לחץ "Register"
4. **המשתמש החדש ייקלט אוטומטית כ-Customer** (לקוח)
5. לאחר ההרשמה תועבר אוטומטית למערכת

**💡 שים לב:** רק Admin יכול להוסיף נציגי תמיכה (Agents) דרך המסך "Add Agent".
